...
# PAN only supported on 43012 currently
ifeq (1,$(filter 1,$(PANU_SUPPORT) $(PANNAP_SUPPORT) $(PAN_PTS_SUPPORT)))
ifneq ($(TARGET),CYW943012BTEVK-01)
$(error PANU_INCLUDED PANNAP_INCLUDED and PAN_PTS_SUPPORT only supported on CYW943012BTEVK-01 TARGET)
endif
endif
...
ifeq ($(TARGET),$(filter $(TARGET), CYW920721B2EVK-02 CYW920721M2EVK-01 CYW920721M2EVK-02 CYW920721M2EVB-03 CYW9M2BASE-43012BT CYW943012BTEVK-01))
...
ifneq ($(filter CYW9M2BASE-43012BT CYW943012BTEVK-01 CYW920819EVB-02 CYW920820EVB-02,$(TARGET)),)
...
ifeq ($(TRANSPORT),SPI)
#$(info Transport=SPI)
ifeq ($(TARGET),$(filter $(TARGET), CYW920706WCDEVAL CYW920719B2Q40EVB-01 CYW920721B2EVK-02 CYW920721M2EVK-01 CYW920721M2EVK-02 CYW920721M2EVB-03))
...
ifeq ($(TARGET),$(filter $(TARGET), CYW920721B2EVK-02 CYW920721M2EVK-01 CYW920721M2EVK-02 CYW920721M2EVB-03))
